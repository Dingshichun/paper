...
if __name__ == '__main__':
    ...
    # 不同学习率组合的模型路径D:/FoodScience/Test9_efficientNet/RunData/CBAM-EN-b0/differentLR/0.01_0.5/model/CBAM-EN-b0-28-all.pth
    # 原始EN-b0模型路径 D:/FoodScience/Test9_efficientNet/RunData/origin-ENb0/model/origin-ENb0-11-all.pth
    # AlexNet路径 D:/FoodScience/Data/AlexNet/ModelSave/AlexNet-43-all.pth
    # MobileNetV2路径 D:/FoodScience/Data/MobileNetV2/ModelSave/MobileNetV2-32-all.pth
    # ResNet50路径 D:/FoodScience/Data/ResNet50/ModelSave/ResNet50-50-all.pth
    # ShuffleNet路径 D:/FoodScience/Data/ShuffleNet/ModelSave/ShuffleNet-30-all.pth
    # 原始mobilenetv3-small路径 D:/FoodScience/Data/origin-MB-V3/ModelSave/origin-MB-v3-29-all.pth
    # 改进的mobilenetv3-small路径 D:/FoodScience/Data/MobileNetV3/ModelSave/MB-v3-31-all.pth
    # 原始mobilenetv3-large路径 D:/FoodScience/Data/origin-MB-V3-large/ModelSave/origin-MB-V3-large-27-all.pth
    # 改进mobilenetv3-large路径 D:/FoodScience/Data/change-MB-V3-large/ModelSave/change-MB-V3-large-38-all.pth
    # D:/FoodScience/Data/MobileNetV3/different_LR/0.01_0.5/ModelSave/MB-v3-22-all.pth
    # D:/FoodScience/Data/MobileNetV3/ModelSave/MB-v3-15-all.pth
    # 不同准确率模型的路径 D:/FoodScience/Data/MobileNetV3/different_LR/0.1_0.1/ModelSave/MB-v3-28-all.pth
    # D:/FoodScience/Data/origin-MB-V3-large/ModelSave/origin-MB-V3-large-27-all.pth
