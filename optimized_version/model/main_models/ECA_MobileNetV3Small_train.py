...
from ECA_MobileNetV3_model import mobilenet_v3_small
...
def main(args):
    ...
    pretrained_dict = {
        k: v
        for k, v in MB_V3_pretrained_dict.items()
    ...
    for epoch in range(args.epochs):
        ...
        max_acc = max(val_acc_list)  # 返回准确率最大值，每轮训练后都可能更改。
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--weights",
        type=str,
        default="./mobilenet_v3_small.pth",
    ...
    parser.add_argument(
        "--RunData-save-path",
        type=str,
        default="./Data/ECA_MobileNetV3Small/RunData",
    ...
    parser.add_argument(
        "--model-save-path",
        type=str,
        default="./Data/ECA_MobileNetV3Small/model/ECA_MobileNetV3Small-",
