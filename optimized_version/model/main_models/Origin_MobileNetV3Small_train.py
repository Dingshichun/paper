...
from Origin_MobileNetV3_model import mobilenet_v3_small
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--RunData-save-path",
        type=str,
        default="./Data/Origin_MobileNetV3Small/RunData",
    ...
    parser.add_argument(
        "--model-save-path",
        type=str,
        default="./Data/Origin_MobileNetV3Small/model/Origin_MobileNetV3Small-",
