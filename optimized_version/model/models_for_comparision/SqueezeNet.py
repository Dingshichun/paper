...
def main(args):
    ...
    # 加载官方预训练模型。
    model = torchvision.models.squeezenet1_0(weights=True)
    # print(model)# 查看模型以更改最后的输出种类

    # 更改最后的输出种类数以满足自己的数据
    model.classifier = nn.Sequential(
        nn.Dropout(p=0.5, inplace=False),
        nn.Conv2d(512, args.num_class, kernel_size=(1, 1), stride=(1, 1)),
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--RunData-save-path",
        type=str,
        default="./Data/SqueezeNet/RunData",
    ...
    parser.add_argument(
        "--model-save-path",
        type=str,
        default="./Data/SqueezeNet/model/SqueezeNet-",
