...
def main(args):
    ...
    tb_writer = SummaryWriter('D:/FoodScience/Data/change-MB-V3-large/RunData')
    # tensorboard文件保存的路径
    if os.path.exists("D:/FoodScience/Data/change-MB-V3-large/RunData") is False:
        os.makedirs("D:/FoodScience/Data/change-MB-V3-large/RunData")
        ...
        if epoch > 11:
            if val_acc_list[epoch] < max_acc and epoch - max_acc_index >= 11:
                ...
                torch.save(model.state_dict(),
                           "D:/FoodScience/Data/change-MB-V3-large/ModelSave/change-MB-V3-large-{}-state_dict.pth".format(
                               max_acc_index))
                # 保存证准确率最高的模型参数和架构
                torch.save(model,
                           "D:/FoodScience/Data/change-MB-V3-large/ModelSave/change-MB-V3-large-{}-all.pth".format(
                               max_acc_index))
                break
            else:
                continue
